...
# TAKES USER INPUT AND IMPORT MODULES FOR THE PARTICULAR VERSION
...
# FUNCTION TO RETRIEVE THE VIDEO LINK
def video_title(url):
    try:
...
# INTRODUCTION
def intro():
    print('''Created by Rishav Chatterjee
    Email:- rishavpiku@gmail.com''')


# CHOICE
def prompt():
    
    print ('''\t\t\t Select any of the two modes
